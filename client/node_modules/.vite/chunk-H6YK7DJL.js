...
var require_bn = __commonJS({
  "node_modules/@ethersproject/transactions/node_modules/bn.js/lib/bn.js"(exports, module) {
...
var ErrorCode;
(function(ErrorCode5) {
  ErrorCode5["UNKNOWN_ERROR"] = "UNKNOWN_ERROR";
  ErrorCode5["NOT_IMPLEMENTED"] = "NOT_IMPLEMENTED";
  ErrorCode5["UNSUPPORTED_OPERATION"] = "UNSUPPORTED_OPERATION";
  ErrorCode5["NETWORK_ERROR"] = "NETWORK_ERROR";
  ErrorCode5["SERVER_ERROR"] = "SERVER_ERROR";
  ErrorCode5["TIMEOUT"] = "TIMEOUT";
  ErrorCode5["BUFFER_OVERRUN"] = "BUFFER_OVERRUN";
  ErrorCode5["NUMERIC_FAULT"] = "NUMERIC_FAULT";
  ErrorCode5["MISSING_NEW"] = "MISSING_NEW";
  ErrorCode5["INVALID_ARGUMENT"] = "INVALID_ARGUMENT";
  ErrorCode5["MISSING_ARGUMENT"] = "MISSING_ARGUMENT";
  ErrorCode5["UNEXPECTED_ARGUMENT"] = "UNEXPECTED_ARGUMENT";
  ErrorCode5["CALL_EXCEPTION"] = "CALL_EXCEPTION";
  ErrorCode5["INSUFFICIENT_FUNDS"] = "INSUFFICIENT_FUNDS";
  ErrorCode5["NONCE_EXPIRED"] = "NONCE_EXPIRED";
  ErrorCode5["REPLACEMENT_UNDERPRICED"] = "REPLACEMENT_UNDERPRICED";
  ErrorCode5["UNPREDICTABLE_GAS_LIMIT"] = "UNPREDICTABLE_GAS_LIMIT";
  ErrorCode5["TRANSACTION_REPLACED"] = "TRANSACTION_REPLACED";
  ErrorCode5["ACTION_REJECTED"] = "ACTION_REJECTED";
})(ErrorCode || (ErrorCode = {}));
...
var Provider = class {
  constructor() {
    logger2.checkAbstract(new.target, Provider);
...
var version5 = "rlp/5.7.0";

// node_modules/@ethersproject/address/node_modules/@ethersproject/rlp/lib.esm/index.js
"use strict";
...
"use strict";
var logger4 = new Logger2(version6);
...
function getContractAddress(transaction) {
  ...
  try {
    ...
    logger4.throwArgumentError("missing from address", "transaction", transaction);
  }
  const nonce = stripZeros(arrayify(BigNumber.from(transaction.nonce).toHexString()));
  return getAddress(hexDataSlice(keccak256(encode([from, nonce])), 12));
}

// node_modules/@ethersproject/transactions/node_modules/@ethersproject/constants/lib.esm/bignumbers.js
...
// node_modules/@ethersproject/transactions/node_modules/@ethersproject/constants/lib.esm/index.js
"use strict";

// node_modules/@ethersproject/transactions/node_modules/@ethersproject/logger/lib.esm/_version.js
var version7 = "logger/5.7.0";

// node_modules/@ethersproject/transactions/node_modules/@ethersproject/logger/lib.esm/index.js
"use strict";
...
var Logger3 = class {
  ...
  static from(version15) {
    return new Logger3(version15);
  }
};
Logger3.errors = ErrorCode3;
Logger3.levels = LogLevel3;

// node_modules/@ethersproject/transactions/node_modules/@ethersproject/properties/lib.esm/_version.js
var version8 = "properties/5.7.0";

// node_modules/@ethersproject/transactions/node_modules/@ethersproject/properties/lib.esm/index.js
"use strict";
var logger5 = new Logger3(version8);
...
// node_modules/@ethersproject/transactions/node_modules/@ethersproject/rlp/lib.esm/_version.js
var version9 = "rlp/5.7.0";

// node_modules/@ethersproject/transactions/node_modules/@ethersproject/rlp/lib.esm/index.js
"use strict";
var logger6 = new Logger3(version9);
...
function encode2(object) {
  return hexlify(_encode2(object));
}
function _decodeChildren(data, offset, childOffset, length) {
  ...
  while (childOffset < offset + 1 + length) {
    ...
    if (childOffset > offset + 1 + length) {
      logger6.throwError("child data too short", Logger3.errors.BUFFER_OVERRUN, {});
    }
  }
...
function _decode(data, offset) {
  if (data.length === 0) {
    logger6.throwError("data too short", Logger3.errors.BUFFER_OVERRUN, {});
  }
  if (data[offset] >= 248) {
    const lengthLength = data[offset] - 247;
    if (offset + 1 + lengthLength > data.length) {
      logger6.throwError("data short segment too short", Logger3.errors.BUFFER_OVERRUN, {});
    }
    const length = unarrayifyInteger(data, offset + 1, lengthLength);
    if (offset + 1 + lengthLength + length > data.length) {
      logger6.throwError("data long segment too short", Logger3.errors.BUFFER_OVERRUN, {});
    }
    return _decodeChildren(data, offset, offset + 1 + lengthLength, lengthLength + length);
  } else if (data[offset] >= 192) {
    const length = data[offset] - 192;
    if (offset + 1 + length > data.length) {
      logger6.throwError("data array too short", Logger3.errors.BUFFER_OVERRUN, {});
    }
...
// node_modules/@ethersproject/transactions/node_modules/@ethersproject/signing-key/lib.esm/elliptic.js
...
// node_modules/@ethersproject/transactions/node_modules/@ethersproject/signing-key/lib.esm/_version.js
var version10 = "signing-key/5.7.0";

// node_modules/@ethersproject/transactions/node_modules/@ethersproject/signing-key/lib.esm/index.js
"use strict";
var logger7 = new Logger3(version10);
var _curve = null;
function getCurve() {
  if (!_curve) {
...
var SigningKey = class {
  constructor(privateKey) {
    ...
    defineReadOnly2(this, "privateKey", hexlify(privateKey));
    if (hexDataLength(this.privateKey) !== 32) {
      logger7.throwArgumentError("invalid private key", "privateKey", "[[ REDACTED ]]");
    }
    const keyPair2 = getCurve().keyFromPrivate(arrayify(this.privateKey));
    defineReadOnly2(this, "publicKey", "0x" + keyPair2.getPublic(false, "hex"));
    defineReadOnly2(this, "compressedPublicKey", "0x" + keyPair2.getPublic(true, "hex"));
...
"use strict";
var logger8 = new Logger3(version11);
...
function serialize(transaction, signature2) {
  ...
  return logger8.throwError(`unsupported transaction type: ${transaction.type}`, Logger3.errors.UNSUPPORTED_OPERATION, {
...
function parse(rawTransaction) {
  ...
  return logger8.throwError(`unsupported transaction type: ${payload[0]}`, Logger3.errors.UNSUPPORTED_OPERATION, {
...
var Logger4 = class {
  ...
  static globalLogger() {
    if (!_globalLogger4) {
      _globalLogger4 = new Logger4(version12);
    }
...
var version13 = "properties/5.7.0";
...
var logger9 = new Logger4(version13);
function defineReadOnly3(object, name, value) {
  Object.defineProperty(object, name, {
    enumerable: true,
    value,
    writable: false
...
var logger10 = new Logger4(version14);
...
var Signer = class {
    ...
    return __awaiter4(this, void 0, void 0, function* () {
      ...
      if ((tx.type === 2 || tx.type == null) && (tx.maxFeePerGas != null && tx.maxPriorityFeePerGas != null)) {
        ...
        if (tx.type == null) {
          if (feeData.maxFeePerGas != null && feeData.maxPriorityFeePerGas != null) {
            ...
            if (hasEip1559) {
              logger10.throwError("network does not support EIP-1559", Logger4.errors.UNSUPPORTED_OPERATION, {
            ...
            logger10.throwError("failed to get consistent fee data", Logger4.errors.UNSUPPORTED_OPERATION, {
      ...
      if (tx.gasLimit == null) {
        tx.gasLimit = this.estimateGas(tx).catch((error) => {
          ...
          return logger10.throwError("cannot estimate gas; transaction may fail or may require manual gas limit", Logger4.errors.UNPREDICTABLE_GAS_LIMIT, {
            error,
            tx
          });
        });
  ...
  _checkProvider(operation) {
    if (!this.provider) {
      logger10.throwError("missing provider", Logger4.errors.UNSUPPORTED_OPERATION, {
...
//# sourceMappingURL=chunk-H6YK7DJL.js.map
